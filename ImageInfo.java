...
public class ImageInfo
{
  ...
  public ImageInfo(ImageInfo src)
  {
    ...
    this.exifDirectory = src.exifDirectory;
    this.exif0Directory = src.exif0Directory;
  ...
  {
      return exif0Directory.getLongObject(ExifSubIFDDirectory.TAG_ORIENTATION);
  }
  ...
  */
  ...
  public int getRating ()
  {
    ...
    String value = getExifDescription(0x4746);
    if (value == null)
        return 0;
    try
      {
